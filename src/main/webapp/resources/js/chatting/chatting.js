...
$(function(){
   ...
   $(document).on("scroll", "#chat_section", function(){
   ...
   //이모티콘 박스 보이기
   $(document).on("click", ".emoticon_icon", function(){
      $(".emoticon_section").toggle();
   })


   //이모티콘 선택하면 div에 넣기
   $(document).on("click", ".emoticon_box>.emoticon", function(){
   ...
   //코드 편집기 열기
   var code_index = 1;
   $(document).on("click", ".code_icon", function(){
