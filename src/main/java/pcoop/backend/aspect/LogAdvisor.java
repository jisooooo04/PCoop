...
public class LogAdvisor {
	...
	public Object loginCheck(ProceedingJoinPoint pjp) throws Throwable {
		...
		if(mdto == null) {
			System.out.println("LogAdvisor > loginCheck 가 로그인 되지않은 사용자를 메인화면으로 리다이렉트 합니다!");
			return "redirect:/";
		}		
	...
	public Object projectCheck(ProceedingJoinPoint pjp) throws Throwable {
		  ...
		  if(pdto == null) {
			System.out.println("LogAdvisor > projectCheck 가 프로젝트를 선택하지 않은 사용자를 메인화면으로 리다이렉트 합니다!");
			return "redirect:/";
		}		
